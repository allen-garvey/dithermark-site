...
<div class="home-copy">
    <p>Do you love pixel art, needlepoint, old-school computer graphics or retro video games? One thing these art forms share is using a small color palette to simulate a larger range of colors. Today, a similar effect can be achieved by using <a href="https://en.wikipedia.org/wiki/Dither#Digital_photography_and_image_processing">image dithering</a> or <a href="https://en.wikipedia.org/wiki/Color_quantization">color quantization</a> algorithms.
    </p>
