    ...
    <div>
        <?php foreach($faqList->faq as $faq): ?>
            <div class="faq-container" id="<?= $faq['id']; ?>">
                ...
                <div class="faq-answer"><p><?= str_replace('${DITHERMARK_GITHUB_URL}', DITHERMARK_GITHUB_URL, str_replace('${APPENDIX_PAGE_URL}', APPENDIX_PAGE_URL, PageView::smartenSingleQuotes(PageView::innerXml($faq->answer, 'answer')))); ?></p></div>
            </div>
        <?php endforeach; ?>
    </div>
</div>
